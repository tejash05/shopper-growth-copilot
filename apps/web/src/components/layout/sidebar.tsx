...
import { BarChart3, LayoutDashboard, Megaphone, Sparkles, Users } from 'lucide-react';
...
const NAV = [
  ...
  { href: '/campaigns/studio', label: 'Campaign Studio', icon: Sparkles },
    ...
    <aside className="sticky top-0 hidden h-screen w-60 shrink-0 flex-col border-r border-border bg-card lg:flex">
      ...
      <div className="border-t border-border p-4">
        <div className="rounded-lg bg-muted/60 p-3">
          <p className="text-xs font-medium text-foreground">NovaWear</p>
          <p className="text-xs text-muted-foreground">Fashion retail · Demo brand</p>
        </div>
      </div>
    </aside>
  );
